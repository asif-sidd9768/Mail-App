...
export const MailFilters = () => {
  ...
  return (
    <div className='filters-container'>
      ...
      {
        !(location.pathname === "/spam") && <span onClick={handleStarUnstarFilter} title={`${state.starUnStarredFilter==="star" ? "Filter unstarred" : "Filter starred"}`} className={`mail-filter-btn filter-btn ${state.starUnStarredFilter === "starred" ? "mail-star-filter-btn" : "mail-unstar-filter-btn"}`}>
